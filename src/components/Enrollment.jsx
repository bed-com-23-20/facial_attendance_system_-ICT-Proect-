...
import RegistrationForm from './popup'
 const Enrollment = ({orgUnit}) => {
    ...
    const [showEnrollment, setShowEnrollment] = useState(false); // State for showing enrollment form
...
//
    ...
    return (
      <div style={{ padding: '10px', position: 'relative', backgroundColor: 'rgba(240, 240, 240, 0.9)' }}>
        ...
        {/* Main Content */}
        {!showEnrollmentForm && (
          <div style={{ border: '1px solid #ccc', borderRadius: '8px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
            <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-start', fontSize: '18px', fontFamily: 'Roboto, sans-serif' }}>
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
                ...
                <span style={{ color: 'red', marginLeft: '5px' }}>2025</span>
                  ...
                  <div style={{ marginTop: '20px', fontSize: '1.3rem', fontWeight: 'bold', color: '#4caf50' }}>
                    <button onClick={()=> setShowEnrollment(true)}>Enrollment Form</button>
                  </div>
    ...
    >
      No Student or any Information match your search.
          ...
          {
            showEnrollment && (
              <div className='absolute top-0 left-0  w-full bg-gray-50 bg-opacity-60 font-sans p-5 h-full'>
              <RegistrationForm closeForm ={handEnroll}/>  
